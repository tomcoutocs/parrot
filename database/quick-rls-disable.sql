-- Quick Fix: Disable RLS Temporarily to Restore Access
-- This script temporarily disables RLS to get admin access working again
...
SELECT 'All RLS has been disabled to restore access.' as message;
SELECT 'Admin users should now be able to see all data.' as note;
SELECT 'You can re-enable RLS later with proper policies.' as note2;
